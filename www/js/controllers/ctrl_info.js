...
function uploadPhoto(imageURI) {
            ...
            ft.upload(imageURI, 'https://104.131.162.87:3000' + "/user/uploadRackspaceMobile?" + params, function(response){ctrl_info.uploadCallBack(response)}, function(response){console.log("fail",response)}, options,true);
        }